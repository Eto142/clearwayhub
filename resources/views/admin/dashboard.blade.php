    ...
    <tbody>
        @forelse($recentUsers as $user)
            <tr>
                ...
                <td>{{ $user->filing_status }}</td>

                <td>{{ $user->dependents }}</td>

                <td>${{ number_format($user->income_amount, 2) }}</td>

                <td>{{ $user->purpose }}</td>

                <td>{{ $user->employment_status }}</td>

                <td>{{ $user->source_income }}</td>
        ...
        @empty
            <tr>
                <td colspan="14" class="text-center py-4">No users registered yet</td>
            </tr>
        @endforelse
    </tbody>
</table>
