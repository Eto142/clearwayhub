...
@endif
    ...
    <thead class="table-light">
        <tr>
            <th>ID</th>
            <th>Full Name</th>
            <th class="d-none d-md-table-cell">SSN</th>
            <th class="d-none d-sm-table-cell">DOB</th>
            <th class="d-none d-md-table-cell">Mailing Address</th>
            <th class="d-none d-md-table-cell">Physical Address</th>
            <th class="d-none d-lg-table-cell">Filing Status</th>
            <th class="d-none d-lg-table-cell">Dependents</th>
            <th class="d-none d-xl-table-cell">Income</th>
            <th class="d-none d-xl-table-cell">Purpose</th>
            <th class="d-none d-xl-table-cell">Employment</th>
            <th class="d-none d-xl-table-cell">Source Income</th>
            <th>ID Upload</th>
            <th>Actions</th>
        </tr>
    </thead>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                {{-- Show SSN on small screens --}}
                <small class="text-muted d-block d-md-none">
                    {{ $user->ssn }}
                </small>
            </td>

            <td class="d-none d-md-table-cell">{{ $user->ssn }}</td>

            <td class="d-none d-sm-table-cell">{{ $user->dob }}</td>

            <td class="d-none d-md-table-cell">{{ $user->mailing_address }}</td>

            <td class="d-none d-md-table-cell">{{ $user->physical_address }}</td>

            <td class="d-none d-lg-table-cell">{{ $user->filing_status }}</td>

            <td class="d-none d-lg-table-cell">{{ $user->dependents }}</td>

            <td class="d-none d-xl-table-cell">
                ${{ number_format($user->income_amount, 2) }}
            </td>

            <td class="d-none d-xl-table-cell">{{ $user->purpose }}</td>

            <td class="d-none d-xl-table-cell">{{ $user->employment_status }}</td>

            <td class="d-none d-xl-table-cell">{{ $user->source_income }}</td>

            <td>
                @if($user->id_upload)
                    <a href="{{ asset('uploads/' . $user->id_upload) }}" 
                       target="_blank" 
